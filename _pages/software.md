...
<!-- <div class="software-item">
  <details>
    <summary>
      <div class="software-preview">
        <img src="/images/software-example-2.png" alt="Software Preview" onerror="this.style.display='none'">
        <div>
          <strong>Another Project</strong>
          <div class="software-meta">Another brief description</div>
        </div>
      </div>
    </summary>
    <div class="software-content">
      <p>Content for the second project...</p>
      <div class="software-links">
